            ...
            <div className="row">
              <div className="xs-10">
                <div className="n-title-block">
                  ...
                  <a href="https://github.com/nulllogic/nulllogic.github.io" className="btn n-btn n-has-icon n-icon-download">Download</a>
                  <a href="https://github.com/nulllogic/nulllogic.github.io" className="btn n-btn n-has-icon n-icon-docs">View docs</a>
                </div>
              </div>
