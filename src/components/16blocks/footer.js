    ...
    <footer>
      <div className="b-outro">
        <div className="row">
          <div className="md-one-third">
            ...
            <p>16Blocks is made by <a href="http://www.nulllogic.net/">NullLogic</a>, a product design company in
              Moscow,
      ...
      <div className="footer">
        ...
        <p>Designed and built with all the love in the world by @mdo and @fat. Maintained by the core team with the help
          of our contributors. <br/>Code licensed MIT, docs CC BY 3.0.
        </p>
      </div>
      <noscript>
        <div><img src="https://mc.yandex.ru/watch/35444710" style="position:absolute; left:-9999px;" alt=""/></div>
      </noscript>
