    ...
    <div class="b-section-grid container">
      <div class="row">
        <div class="xs16">
          ...
          <!--BASIC GRID, EXAMPLE ONE-->

          <!--COLUMNS 4/16-->
          <div class="row basics">
            <div class="xs4 column medium-green">
              4/16
            </div>
            <div class="xs4 column medium-green">
              4/16
          ...
          <!--COLUMNS 1/2-->
          <div class="row basics">
            <div class="xs8 column medium-green">
              8/16
            </div>
            <div class="xs8 column medium-green">
              8/16
          ...
          <div class="row nesting">
            <div class="xs16 column light-green">
              16/16
              <div class="row medium-green">
                <div class="xs4 column">
                  4/16
                </div>
                <div class="xs8 column">
                  8/16
          ...
          <div class="row centering">
            <div class="xs3 column centered medium-green">
              3/16
            </div>
            <div class="xs6 column centered medium-green">
              6/16
            </div>
            <div class="xs9 column centered medium-green">
              9/16
            </div>
          </div>
          ...
          <div class="mobile">
            <div class="row">
              <div class="xs4 column medium-green">.xs4</div>
              <div class="xs4 column medium-green">.xs4</div>
              <div class="xs4 column medium-green">.xs4</div>
              <div class="xs4 column medium-green">.xs4</div>
            </div>
            <div class="row">
              <div class="sm4 column medium-green">.xm4</div>
              <div class="sm4 column medium-green">.xm4</div>
              <div class="sm4 column medium-green">.xm4</div>
              <div class="sm4 column medium-green">.xm4</div>
            </div>
            <div class="row">
              <div class="md4 column medium-green">.md4</div>
              <div class="md4 column medium-green">.md4</div>
              <div class="md4 column medium-green">.md4</div>
              <div class="md4 column medium-green">.md4</div>
            </div>
            <div class="row">
              <div class="lg4 column medium-green">.lg4</div>
              <div class="lg4 column medium-green">.lg4</div>
              <div class="lg4 column medium-green">.lg4</div>
              <div class="lg4 column medium-green">.lg4</div>
            </div>
            <div class="row">
              <div class="xl4 column medium-green">.xl4</div>
              <div class="xl4 column medium-green">.xl4</div>
              <div class="xl4 column medium-green">.xl4</div>
              <div class="xl4 column medium-green">.xl4</div>
            </div>
